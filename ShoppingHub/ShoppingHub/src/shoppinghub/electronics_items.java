 ...
 */
public class electronics_items extends javax.swing.JFrame {

    /**
     * Creates new form electronics_items
     */
   Connection conn;
   PreparedStatement param;
   ResultSet rs;
    public electronics_items() {
        initComponents();
    ...
    public void update(){
          try{
               sql="select * from electronics_item order by item_no asc";
    ...
    private void initComponents() {
        ...
        image_button.setBounds(90, 340, 150, 29);
        ...
        submit_button.setBounds(250, 395, 120, 40);
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item_no", "Price", "Location", "Picture"
            }
        ) {
        ...
        jScrollPane1.setBounds(490, 70, 452, 290);

        setSize(new java.awt.Dimension(1006, 500));
    ...
    private void submit_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit_buttonActionPerformed
        ...
        FileInputStream fin = null;
         ...
         int ln=(int) f.length();
         try{
             String sql="INSERT INTO electronics_item VALUES (?,?,?,?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(electronics_items.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new electronics_items().setVisible(true);
            }
        });
    }
